      ...
      it(`injectToStream - useAsync() - ${streamType} stream${disable ? ' - disabled' : ''}`, async () => {
...

        {
          const dataContent = [
            ...
            // Injection useAsync()
            '<script class="react-streaming_ssr-data" type="application/json">{"key":"hello-component-key","value":"Hello, I was lazy.","deps":[]}</script>',
            // Suspense resolving
          ...
          try {
            ...
            console.log('expected:', dataContent)
